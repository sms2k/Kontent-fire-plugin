        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-gray-900">
              Welcome to <span className="fire-gradient-text">Kontent Fire</span>
            </h2>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-brand-600 hover:text-brand-500 transition">
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/register" className="font-medium text-brand-600 hover:text-brand-500 transition">
                  Sign up for free
                </Link>
              </p>
            </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12 text-white">
          <div className="max-w-md space-y-6 animate-fade-in">
            ...
            <p className="text-xl text-white/90">
              Generate SEO-optimized blogs, stunning images, engaging videos, and viral social media posts - all powered by advanced AI.
            </p>
            <div className="space-y-3 pt-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/90">Claude Sonnet 4.5 & GPT-4 Powered</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-white/90">Imagen 4 & Veo 3 for Media</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-white/90">Multi-Platform Publishing</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-white/90">SEO Optimization Built-in</span>
              </div>
            </div>
          </div>
        </div>
